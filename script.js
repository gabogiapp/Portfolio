...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Apply animations to projects and timeline items
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (targetSection) {
                const offsetTop = targetSection.offsetTop - 80; // Account for any fixed nav
                window.scrollTo({
                    top: offsetTop,
                    behavior: 'smooth'
                });
    ...
    console.log('Vanta.js available:', !!window.VANTA);
